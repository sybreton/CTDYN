...
C  enter beta (=x) and J,  and output the correction at r/R=1
...
C gamma is fixed so that at about z=zeta_r  so that the field lines open!
...
c
c derivative of Psi and Phi are zero at the normalized radius z=r/R ??? ???
c
          gam = (-z*x*rjm1+rjz+z*x*rjz1)/(z*x*rym1-ryz-z*x*ryz1) 

c          corr= x*(gam*ry1+rj1)/(gam*ry+rj)-(J*2.d0+1)
...
c derivative of Psi and Phi are zero at the normalized radius z=r/R ??? ???
c
c          gam = (-z*x*rjm1+rjz+z*x*rjz1)/(z*x*rym1-ryz-z*x*ryz1) 

          gam = -(-z*x*rjm1+rjz+z*x*rjz1)/(z*x*rym1-ryz-z*x*ryz1) 

c          corr= x*(gam*ry1+rj1)/(gam*ry+rj)-(J*2.d0+1)

c          corn = (ry1*(-z*x*rjm1+rjz+z*x*rjz1)+ rj1*(z*x*rym1-ryz-z*x*ryz1))
c          cord = (ry*(-z*x*rjm1+rjz+z*x*rjz1)+ rj*(z*x*rym1-ryz-z*x*ryz1))
